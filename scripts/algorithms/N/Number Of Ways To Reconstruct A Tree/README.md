<h3 align="left"> 1719. Number Of Ways To Reconstruct A Tree</h3>
<div><p>You are given an array <code>pairs</code>, where <code>pairs[i] = [x<sub>i</sub>, y<sub>i</sub>]</code>, and:</p>
