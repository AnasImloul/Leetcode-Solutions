<h3 align="left"> 2319. Check if Matrix Is X-Matrix</h3>
<div><p>A square matrix is said to be an <strong>X-Matrix</strong> if <strong>both</strong> of the following conditions hold:</p>
