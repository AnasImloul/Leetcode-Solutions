<h3 align="left"> 2194. Cells in a Range on an Excel Sheet</h3>
<div><p>A cell <code>(r, c)</code> of an excel sheet is represented as a string <code>"&lt;col&gt;&lt;row&gt;"</code> where:</p>
