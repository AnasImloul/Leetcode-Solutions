<h3 align="left"> 1309. Decrypt String from Alphabet to Integer Mapping</h3>
<div><p>You are given a string <code>s</code> formed by digits and <code>'#'</code>. We want to map <code>s</code> to English lowercase characters as follows:</p>
