<h3 align="left"> 2331. Evaluate Boolean Binary Tree</h3>
<div><p>You are given the <code>root</code> of a <strong>full binary tree</strong> with the following properties:</p>
