<h3 align="left"> 2178. Maximum Split of Positive Even Integers</h3>
<div><p>You are given an integer <code>finalSum</code>. Split it into a sum of a <strong>maximum</strong> number of <strong>unique</strong> positive even integers.</p>
