<h3 align="left"> 2170. Minimum Operations to Make the Array Alternating</h3>
<div><p>You are given a <strong>0-indexed</strong> array <code>nums</code> consisting of <code>n</code> positive integers.</p>
