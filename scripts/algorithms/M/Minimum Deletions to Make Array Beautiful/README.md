<h3 align="left"> 2216. Minimum Deletions to Make Array Beautiful</h3>
<div><p>You are given a <strong>0-indexed</strong> integer array <code>nums</code>. The array <code>nums</code> is <strong>beautiful</strong> if:</p>
