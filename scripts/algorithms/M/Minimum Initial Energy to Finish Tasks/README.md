<h3 align="left"> 1665. Minimum Initial Energy to Finish Tasks</h3>
<div><p>You are given an array <code>tasks</code> where <code>tasks[i] = [actual<sub>i</sub>, minimum<sub>i</sub>]</code>:</p>
