<h3 align="left"> 2310. Sum of Numbers With Units Digit K</h3>
<div><p>Given two integers <code>num</code> and <code>k</code>, consider a set of positive integers with the following properties:</p>
